...
export default function SimulacaoPage() {
  ...
  return (
    // MUDANÇA: Removido w-screen e h-screen, ajustado o main
    <div>
      <main className="flex flex-col min-h-screen pt-[80px]">
        {creatureCount === null ? (
          <div
            className="w-full h-full flex flex-col items-center justify-center p-24 bg-cover bg-center"
          ...
          <SimulationClient initialCreatureCount={creatureCount} />
        )}
      </main>
    </div>
  );
