 ...
 * simulação. Garante que o serviço de simulação esteja sempre disponível após a
 * construção.
 */
@Component
public class SimulationManager {
     ...
     * @throws IllegalArgumentException se a quantidade for inválida (lançada
     * por SimulationService)
